...
class InteractionObservationEvent extends Event:
	...
	func _init(piece: Gamepiece, obs: Observation) -> void:
...
static func create_interaction_observation(piece: Gamepiece, observation: Observation) -> InteractionObservationEvent:
