...
signal gamepiece_path_set(gamepiece: Gamepiece, destination_cell: Vector2i)
signal gamepiece_clicked(gamepiece: Gamepiece)
signal gamepiece_destroyed(gamepiece: Gamepiece)

## NPC related signals
signal npc_need_changed(gamepiece: Gamepiece, need_id: String, new_value: float)

## Emitted when the focused gamepiece changes. Used to update UI elements.
signal focused_gamepiece_changed(new_focused_gamepiece: Gamepiece)
