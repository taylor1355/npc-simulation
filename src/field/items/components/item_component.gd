...
# Raw values received from ItemController before type conversion
...
# Called by ItemController to configure all properties at once
...
# Called by ItemController via set() to store raw property values
